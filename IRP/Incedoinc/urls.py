...
urlpatterns = [
    ...
    path('delete_temp_candidate/<int:candidate_id>/', views.delete_temp_candidate, name = 'delete_temp_candidate'),
    path('delete_temp_candidate/', views.delete_temp, name = 'delete_temp'),
