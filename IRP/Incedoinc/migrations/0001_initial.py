# Generated by Django 3.1.6 on 2021-03-15 09:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CGPA', models.DecimalField(blank=True, decimal_places=3, max_digits=5, null=True)),
                ...
                ('notice_period', models.CharField(blank=True, max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requisition_status', models.CharField(choices=[('Open', 'Open'), ('Offered', 'Offered'), ('On-Hold', 'On-Hold'), ('Closed', 'Closed')], default='Open', max_length=20)),
                ('total_positions', models.IntegerField(default=1)),
                ('open_to_internal', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate_status', models.CharField(choices=[('Selected', 'Selected'), ('Rejected', 'Rejected'), ('On-Hold', 'On-Hold'), ('Offered', 'Offered'), ('Joined', 'Joined'), ('In-Progress', 'In-Progress'), ('Offered(Buffer)', 'Offered(Buffer)')], default='In-Progress', max_length=20)),
                ('candidate_email', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Incedoinc.candidate')),
        ...
        migrations.AddField(
            ...
            name='registered_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Incedoinc.employee'),
        ),
    ]
