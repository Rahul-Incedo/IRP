# Generated by Django 3.1.5 on 2021-03-03 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate_status', models.CharField(choices=[('Selected', 'Selected'), ('Rejected', 'Rejected'), ('On-hold', 'On-hold'), ('Offered', 'Offered'), ('Joined', 'Joined'), ('In-Progress', 'In-Progress')], default='In-Progress', max_length=20)),
                ('candidate_email', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Incedoinc.candidate')),
